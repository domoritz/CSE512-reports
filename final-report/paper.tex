...
\begin{figure}[ht]
  ...
  \begin{subfigure}[b]{0.49\columnwidth}
    ...
    \label{fig:no-skew}
  \end{subfigure}
  \caption{The network view shows a distinctive pattern when there is data skew. Figure~\ref{fig:skew} shows that most tuples are sent to worker 1 and 5 (origin: x-axis, destination: y-axis).}
  \label{fig:network}
\end{figure}
