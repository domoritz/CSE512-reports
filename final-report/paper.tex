...
utilization and (4) network utilization.
...
\begin{itemize}
\item \emph{How does the data flow through the workers between query fragments?} 
\item \emph{How can we identify data skew and execution skew?} 
\item \emph{What causes performance bottlenecks?}
\end{itemize}
...
work is executed on different workers during different stages of the execution. Distinct points on the lines are highlighted as
