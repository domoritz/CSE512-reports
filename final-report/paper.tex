...
distributed. This requires programmers or database developers to spend
...
database programmer or developer could quickly discover run-time bottlenecks as well as problematic data skew issues,
...
communication between distributed workers. \system is designed to help the Myria programmer answer the following questions regarding
...
for the programmer to understand the \graph in order to optimize it. To aid in this
